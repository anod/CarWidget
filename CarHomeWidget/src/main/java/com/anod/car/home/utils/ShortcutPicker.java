...
public class ShortcutPicker {
    ...
    public void showEditActivity(int cellId, long shortcutId, int appWidgetId) {
        Intent editIntent = ShortcutEditActivity.createIntent(mContext, cellId, shortcutId,
                appWidgetId);
