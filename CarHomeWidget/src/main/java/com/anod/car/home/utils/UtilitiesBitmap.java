        ...
        synchronized (sCanvas) { // we share the statics :-(
            ...
            if (width > 0 && height > 0) {
                if (width < bitmapWidth || height < bitmapHeight) {
                    ...
                    final Bitmap.Config c = (width == sIconSize && height == sIconSize
                            && bitmap.getConfig() != null) ? bitmap.getConfig()
                    ...
                    paint.setDither(false);
                    paint.setFilterBitmap(true);
                    canvas.drawBitmap(bitmap, (sIconSize - bitmapWidth) / 2,
                            (sIconSize - bitmapHeight) / 2, paint);
                    return thumb;
                }
            }
